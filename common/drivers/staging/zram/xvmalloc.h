...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Kernel-Nexus7/drivers/staging/zram/xvmalloc.h at master · motley-git/Kernel-Nexus7</title>
...
<meta content="2cRprTdeGeMej+y4qCrR6po2DjANZEtj0rDCbpPqWSo=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-6f3bd550f3d93d807bbc14d8cfce5a5a393cf3f7.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/motley-git/Kernel-Nexus7/blob/02eea732fc1f834d620eba4a5a21785fd913ab71/drivers/staging/zram/xvmalloc.h'>
          ...
          <div class="js-filter-tab js-filter-branches">
            <div data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target selected">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/motley-git/Kernel-Nexus7/blob/master/drivers/staging/zram/xvmalloc.h" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/motley-git/Kernel-Nexus7/blob/motley_v2/drivers/staging/zram/xvmalloc.h" class="js-navigation-open" data-name="motley_v2" rel="nofollow">motley_v2</a>
                  </h4>
                </div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/motley-git/Kernel-Nexus7/blob/motley_v3/drivers/staging/zram/xvmalloc.h" class="js-navigation-open" data-name="motley_v3" rel="nofollow">motley_v3</a>
                  </h4>
                </div>
            </div>
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="drivers/staging/zram/xvmalloc.h/" data-permalink-url="/motley-git/Kernel-Nexus7/blob/02eea732fc1f834d620eba4a5a21785fd913ab71/drivers/staging/zram/xvmalloc.h" data-title="Kernel-Nexus7/drivers/staging/zram/xvmalloc.h at master · motley-git/Kernel-Nexus7 · GitHub" data-type="blob">
              ...
              <ul class="button-group actions">
                  <li>
                        <a class="grouped-button minibutton bigger lighter tooltipped leftwards"
                           ...
                           href="/motley-git/Kernel-Nexus7/edit/master/drivers/staging/zram/xvmalloc.h"
                           data-method="post" rel="nofollow">Edit</a>
                  </li>
                <li><a href="/motley-git/Kernel-Nexus7/raw/master/drivers/staging/zram/xvmalloc.h" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a></li>
                  <li><a href="/motley-git/Kernel-Nexus7/blame/master/drivers/staging/zram/xvmalloc.h" class="minibutton grouped-button bigger lighter">Blame</a></li>
                <li><a href="/motley-git/Kernel-Nexus7/commits/master/drivers/staging/zram/xvmalloc.h" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a></li>
              </ul>
            </div>
...
<span id="L30" rel="#L30">30</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cm">/*</span></div><div class='line' id='LC2'><span class="cm"> * xvmalloc memory allocator</span></div><div class='line' id='LC3'><span class="cm"> *</span></div><div class='line' id='LC4'><span class="cm"> * Copyright (C) 2008, 2009, 2010  Nitin Gupta</span></div><div class='line' id='LC5'><span class="cm"> *</span></div><div class='line' id='LC6'><span class="cm"> * This code is released using a dual license strategy: BSD/GPL</span></div><div class='line' id='LC7'><span class="cm"> * You can choose the licence that better fits your requirements.</span></div><div class='line' id='LC8'><span class="cm"> *</span></div><div class='line' id='LC9'><span class="cm"> * Released under the terms of 3-clause BSD License</span></div><div class='line' id='LC10'><span class="cm"> * Released under the terms of GNU General Public License Version 2.0</span></div><div class='line' id='LC11'><span class="cm"> */</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'><span class="cp">#ifndef _XV_MALLOC_H_</span></div><div class='line' id='LC14'><span class="cp">#define _XV_MALLOC_H_</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'><span class="cp">#include &lt;linux/types.h&gt;</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="k">struct</span> <span class="n">xv_pool</span><span class="p">;</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="k">struct</span> <span class="n">xv_pool</span> <span class="o">*</span><span class="n">xv_create_pool</span><span class="p">(</span><span class="kt">void</span><span class="p">);</span></div><div class='line' id='LC21'><span class="kt">void</span> <span class="n">xv_destroy_pool</span><span class="p">(</span><span class="k">struct</span> <span class="n">xv_pool</span> <span class="o">*</span><span class="n">pool</span><span class="p">);</span></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'><span class="kt">int</span> <span class="n">xv_malloc</span><span class="p">(</span><span class="k">struct</span> <span class="n">xv_pool</span> <span class="o">*</span><span class="n">pool</span><span class="p">,</span> <span class="n">u32</span> <span class="n">size</span><span class="p">,</span> <span class="k">struct</span> <span class="n">page</span> <span class="o">**</span><span class="n">page</span><span class="p">,</span></div><div class='line' id='LC24'>			<span class="n">u32</span> <span class="o">*</span><span class="n">offset</span><span class="p">,</span> <span class="n">gfp_t</span> <span class="n">flags</span><span class="p">);</span></div><div class='line' id='LC25'><span class="kt">void</span> <span class="n">xv_free</span><span class="p">(</span><span class="k">struct</span> <span class="n">xv_pool</span> <span class="o">*</span><span class="n">pool</span><span class="p">,</span> <span class="k">struct</span> <span class="n">page</span> <span class="o">*</span><span class="n">page</span><span class="p">,</span> <span class="n">u32</span> <span class="n">offset</span><span class="p">);</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="n">u32</span> <span class="n">xv_get_object_size</span><span class="p">(</span><span class="kt">void</span> <span class="o">*</span><span class="n">obj</span><span class="p">);</span></div><div class='line' id='LC28'><span class="n">u64</span> <span class="n">xv_get_total_size_bytes</span><span class="p">(</span><span class="k">struct</span> <span class="n">xv_pool</span> <span class="o">*</span><span class="n">pool</span><span class="p">);</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'><span class="cp">#endif</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2012 <span title="0.11331s from fe18.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.11456' data-host='fe18'></span>
